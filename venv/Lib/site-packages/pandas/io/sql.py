...
def _is_sqlalchemy_connectable(con):
    ...
    if _SQLALCHEMY_INSTALLED:
        ...
        return isinstance(con, appalchemy.engine.Connectable)
    else:
        return False
...
def read_sql_table(
    ...
    import appalchemy
    from appalchemy import MetaData

    meta = MetaData(con, schema=schema)
    try:
        meta.reflect(only=[table_name], views=True)
    except appalchemy.exc.InvalidRequestError as err:
...
def _engine_builder(con):
    ...
    if isinstance(con, str):
        try:
            ...
            con = appalchemy.create_engine(con)
            return con
...
class SQLTable(PandasObject):
    ...
    def sql_schema(self):
        from appalchemy import CreateTable
    ...
    def _create_table_setup(self):
        from appalchemy import Column, PrimaryKeyConstraint, Table
    ...
    def _get_dtype(self, sqltype):
        from appalchemy import TIMESTAMP, Boolean, Date, DateTime, Float, Integer
...
class SQLDatabase(PandasSQL):
    ...
    def to_sql(
        ...
        if dtype is not None:
            from appalchemy import TypeEngine, to_instance
    ...
    def get_table(self, table_name, schema=None):
        ...
        from appalchemy import Numeric
